...
_kubebuilder_download_sdk = repository_rule(
    ...
    attrs = {
        "version": attr.string(default = "4.3.0"),
        "urls": attr.string_list(
            default = [
                "https://github.com/kubernetes-sigs/kubebuilder/releases/download/v{version}/kubebuilder_{platform}.tar.gz",
            ],
        ),
...
def kubebuilder_register_sdk(version = "4.3.0"):
